...
def main() -> None:
    ...
    metrics_path = Path("results/tables/generated/mc_dropout_metrics.json")
    ...
    print(f"Evaluating MC Dropout with dropout_p={dropout_p}, n_passes={n_passes}")
    ...
    plot_confidence_histogram(
        ...
        title="MC Dropout Confidence Histogram",
    )
